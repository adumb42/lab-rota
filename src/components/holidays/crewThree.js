...
class CrewThree extends React.Component {
    ...
    renderUnapprovedHolidays() {
        ...
        return this.props.holidays.map(holiday => {
            if (holiday.crewThreeApproved === false) {
            ...
            } if (holiday.crewThreeApproved === true) {
            ...
            if (holiday.crewThreeEmail === false) {
            ...
            } if (holiday.crewThreeEmail === true) {
            ...
            let updatedAtDate = moment(holiday.crewThreeUpdatedAt).format('DD-MM-YYYY')
            while (
                holiday.crewThree === false &&
                ...
                return (
                    <tbody className="maintable" key={holiday.id}>
                        <tr>
                            ...
                            <td> <button className={emailButton} onClick={() => this.props.approvalToggle(holiday._id, { "crewThreeEmail": !holiday.crewThreeEmail })}>{emailMessage}</button></td>
                        </tr>
                    </tbody>
                )
            }
