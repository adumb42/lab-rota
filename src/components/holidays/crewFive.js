...
class CrewFive extends React.Component {
    ...
    render() {
        ...
        const booked = this.props.holidays.filter(holiday => holiday.crewFive === false).length
        const swapsBooked = 260 - this.props.holidays.filter(holiday => holiday.crewFive === null).length
        const remaining = 5.5 - booked
