...
class CrewFive extends React.Component {
    ...
    renderUnapprovedHolidays() {
        ...
        return this.props.holidays.map(holiday => {
            if (holiday.crewFiveApproved === false) {
            ...
            } if (holiday.crewFiveApproved === true) {
            ...
            if (holiday.crewFiveEmail === false) {
            ...
            let updatedAtDate = moment(holiday.crewFiveUpdatedAt).format('DD-MM-YYYY')
            while (
                holiday.crewFive === false &&
                ...
                return (
                    <tbody className="maintable" key={holiday.id}>
                        <tr>
                            ...
                            <td> <button className={emailButton} onClick={() => this.props.approvalToggle(holiday._id, { "crewFiveEmail": !holiday.crewFiveEmail })}>{emailMessage}</button></td>
                        </tr>
                    </tbody>
                )
            }
    ...
    render() {
        ...
        const booked = this.props.holidays.filter(holiday => holiday.crewFive === false && holiday.id > 364).length
        const swapsBooked = 374 - this.props.holidays.filter(holiday => holiday.crewFive === null).length
        const remaining = 27.5 - booked
        ...
        return this.state.hidden ? (
            ...
            (
                <div>
                    <div className="ui raised card">
                        <div className="content">
                            <div className="header">{this.props.users[4].fullNameOne}</div>
                            <div className="meta">
