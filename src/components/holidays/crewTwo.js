...
class CrewTwo extends React.Component {
    ...
    render() {
        ...
        const booked = this.props.holidays.filter(holiday => holiday.crewTwo === false).length
        const swapsBooked = 115 - this.props.holidays.filter(holiday => holiday.crewTwo === null).length
